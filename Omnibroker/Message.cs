...
namespace TestProtoGen {
    ...
    public abstract class BoundMessage {
        ...
        public string Base64Ticket {
            get { return Convert.ToBase64String(Ticket); }
            }
        public string Base64Mac {
            get { return Convert.ToBase64String(MAC); }
            }
...
Content-Length: {2}
";
        static string ContentIntegrityFormat = "Integrity: mac={0}; ticket={1}\n";
...
Content-Length: {2}
";
        static string ContentIntegrityFormat = "Content-Integrity: mac={0}; ticket={1}\n";
