...
namespace OBPQuery {
	...
	public partial class Payload {
		...
		public Payload (JSONReader JSONReader) {
			Deserialize (JSONReader);
			}
		public Payload (string _String) {
			Deserialize (_String);
			}
        ...
        public static void Deserialize(string _Input, out Payload Out) {
	...
	public partial class Connection {
		bool								__IPVersion = false;
		private int						_IPVersion;
		public int						IPVersion {
			get {return _IPVersion;}
			set {_IPVersion = value; __IPVersion = true; }
			}
		bool								__IPProtocol = false;
		private int						_IPProtocol;
		public int						IPProtocol {
			get {return _IPProtocol;}
			set {_IPProtocol = value; __IPProtocol = true; }
			}
		...
		public virtual void Serialize (Writer Writer, bool wrap, ref bool first) {
			...
			if (__IPVersion){
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("IPVersion", 1);
					Writer.WriteInteger32 (IPVersion);
				}
			if (__IPProtocol){
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("IPProtocol", 1);
					Writer.WriteInteger32 (IPProtocol);
				}
			if (IPAddress != null) {
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("IPAddress", 1);
					Writer.WriteBinary (IPAddress);
				}
			if (__IPPort){
				Writer.WriteObjectSeparator (ref first);
			...
			if (Advice != null) {
				...
				Writer.WriteToken ("Advice", 1);
					Advice.Serialize (Writer, false, ref first);
				}
			if (wrap) {
				Writer.WriteObjectEnd ();
				}
		...
		public virtual void DeserializeToken (JSONReader JSONReader, string Tag) {
			...
			switch (Tag) {
				case "IPVersion" : {
					IPVersion = JSONReader.ReadInteger32 ();
					break;
					}
				case "IPProtocol" : {
					IPProtocol = JSONReader.ReadInteger32 ();
					break;
					}
				case "IPAddress" : {
					IPAddress = JSONReader.ReadBinary ();
					break;
					}
				case "IPPort" : {
		...
		public virtual void Serialize (Writer Writer, bool wrap, ref bool first) {
			...
			if (Connection != null) {
				...
				Writer.WriteToken ("Connection", 1);
					Connection.Serialize (Writer, false, ref first);
				}
			if (wrap) {
				Writer.WriteObjectEnd ();
				}
	...
	public partial class QueryConnectRequest : Request {
		...
		public new void Serialize (Writer Writer, bool wrap, ref bool first) {
			...
			if (Identifier != null) {
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("Identifier", 1);
					Identifier.Serialize (Writer, false, ref first);
				}
			if (Policy != null) {
				Writer.WriteObjectSeparator (ref first);
	...
	public partial class QueryConnectResponse : Response {
	...
	public partial class AdvertiseRequest : Request {
	...
	public partial class AdvertiseResponse : Response {
		public List<Service>				Service;
	...
	public partial class ValidateRequest : Request {
		...
		public new void Serialize (Writer Writer, bool wrap, ref bool first) {
			...
			if (Service != null) {
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("Service", 1);
					Service.Serialize (Writer, false, ref first);
				}
			if (Credential != null) {
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("Credential", 1);
					Credential.Serialize (Writer, false, ref first);
				}
			if (Policy != null) {
				Writer.WriteObjectSeparator (ref first);
				Writer.WriteToken ("Policy", 1);
	...
	public partial class CredentialPasswordRequest : Request {
		public string						Account;
	...
	public partial class CredentialPasswordResponse : Response {
